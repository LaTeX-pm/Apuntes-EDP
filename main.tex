...
%% Datos de la portada
\def\tituloportada {Apuntes de EDP}
\def\autordeldocumento {Francisco Muñoz Guajardo}
\def\repositorio {github.com/LaTeX-pm/Apuntes-EDP}
\def\fecha {\today}
\def\nombredelcurso {Ecuaciones en Derivadas Parciales}
\def\codigodelcurso {MA4802}
